---
title: Llama Assistant - Local AI Assistant That Respects Your Privacy! 🔒
---
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Try Llama Assistant!</h1>
    <p className="subtitle">Your Local AI Assistant That Respects Your Privacy! 🔒</p>
      ...
      <Features>
        ...
        <Feature index={1} centered className="card-with-border" href="/docs">
          <div className="h-full flex flex-col justify-start pt-4">
            <h3> <span style={{ fontWeight: 500 }}>Easy to Get Started</span> <br/></h3>
            <p className='text-center mb-2 mt-4'>Install and Run with Pip</p>
            <div>
              <div className={styles.optimization}>
                <div style={{ fontSize: '1.0rem' }} className="leading-2 text-left">
                  <code>
pip install llama-assistant<br/>
pip install pyaudio
</code>
                </div>
              </div>
